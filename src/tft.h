...
class TFT : public Print {
    ...
    public:
        ...
        void      begin(uint8_t CS=22, uint8_t DC=21);
...
private:
    ...
    File g_pInFileSd; // @suppress("Abstract class cannot be instantiated")
...
public:
    ...
    ~JPEGDecoder();
    int read(void);
    int decodeSdFile (File g_pInFile); // @suppress("Abstract class cannot be instantiated")
    void abort(void);
